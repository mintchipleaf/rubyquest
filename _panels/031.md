...
lines:
    - command: >-
            Look outside, see how far it is to the surface. Also, see if any predatory fish are visible.
      text: >-
            The water is murky. Ruby can see neither the surface nor any details on the sea life swimming past the glass.<div class="linebreak"></div>After entering the code, the bars on the grate finally slide open with a loud "clank"! The access shaft is accessible!
---